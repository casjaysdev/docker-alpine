...
ARG BUILD_DATE="Fri Sep  1 02:30:00 AM EDT 2023"
...
RUN \
  ...
  py_version="$(command $pip_bin --version 2>/dev/null | sed 's|[pP]ython ||g' | awk -F '.' '{print $1$2}' | grep '[0-9]' || true)"; \
...
LABEL \
  ...
  org.opencontainers.image.url="https://hub.docker.com/r/casjaysdev/docker-alpine" \
  org.opencontainers.image.url.source="https://hub.docker.com/r/casjaysdev/docker-alpine" \
  org.opencontainers.image.vcs-type="Git" \
  org.opencontainers.image.vcs-ref="${BUILD_VERSION}" \
  org.opencontainers.image.vcs-url="https://github.com/casjaysdev/docker-alpine" \
  org.opencontainers.image.documentation="https://github.com/casjaysdev/docker-alpine" \
